...
var AudioPlayerController = /** @class */ (function () {
    ...
    AudioPlayerController.prototype.init_shuffle_and_theme_btns = function () {
        ...
        (_a = this.theme_toggle) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
...
function initialize_effects() {
    ...
    class_selectors.forEach(function (selector) {
        DomEffects.random_font_for_class(selector, 0.3, EXTENDED_FONTS);
    });
    id_selectors.forEach(function (selector) {
