...
<form action="{{ route('projects.store') }}" method="POST">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="text" id="tags_input" value="{{ old('tags') ? implode(', ', old('tags')) : '' }}" placeholder="web, php, laravel" style="width: 100%; padding: 8px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="url" id="source" name="source" value="{{ old('source') }}" required style="width: 100%; padding: 8px;">
        @error('source')
            <span style="color: red;">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="url" id="cover_image" name="cover_image" value="{{ old('cover_image') }}" required style="width: 100%; padding: 8px;">
        @error('cover_image')
            <span style="color: red;">{{ $message }}</span>
        @enderror
    </div>
