...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h1 class="text-2xl font-bold text-gray-900 mb-6">Add New Book</h1>
            ...
            <form method="POST" action="{{ route('books.store') }}" id="book-form">
                ...
                <div class="mt-6">
                    ...
                    <input type="text" id="genres_input" value="{{ old('genres') ? implode(', ', old('genres')) : '' }}"
    ...
    <script>
        ...
        `;
            ...
            // Handle comma-separated inputs for genres and tags
